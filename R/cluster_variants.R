...
#' @param n_features Target number of variants to use for clustering
#' @param sample_ID Sample identifier to be added to seurat object
#' @param n_neighbors Passed to uwot::umap
#' @param min_dist Passed to uwot::umap
#' @param dist_metric Passed to uwot::umap
#' @param dbscan_eps Eps metric passed to dbscan::dbscan
#' @param min_data_portion Minimum data availability for filtering variants
#' @param rare_frequency_max Max frequency threshold for selecting rare variants
#' @param min_overlap Minimum number of joint non-NA allele frequency values
#'                    shared between two cells for calulcating cosine distance
