...
#' @param name Identifier given to annotated cells carrying specified variants
#' @param combine_strategy How cells are chosen when multiple variants are provided, either "intersect" (default) or "union"
#' @param genotypes_file Path to the *_genotypes.tsv file containing cell-specific variant info
#' @param reduction Which reduction to use when generating UMAP plots. Usually either
#'   "umap" for ADT-base clusters (default) or "umap.variants" for variant-based clusters
#' @param plot_directory Location to save output plot
